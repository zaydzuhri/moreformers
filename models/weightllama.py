...
class Attention(nn.Module):
    def __init__(self, config):
        ...
        self.key = nn.Parameter(torch.randn(config.n_embd))
        self.value = nn.Parameter(torch.randn(config.n_embd))
