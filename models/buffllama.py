...
class Attention(nn.Module):
    def __init__(self, config):
        ...
        self.query = FeedForward(config, config.n_embd)
        self.key = FeedForward(config, config.n_embd)
        self.value = FeedForward(config, config.n_embd)
...
class Block(nn.Module):
    def __init__(self, config):
        ...
        self.ff = FeedForward(config, config.n_embd * 2)
